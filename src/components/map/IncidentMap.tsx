...
import { AlertTriangle, Map as MapIcon, Search, Calendar, Filter, MapPin, FileDown, Share } from 'lucide-react';
...
// Expanded mock data for incidents
const mockIncidents: Incident[] = [
  ...
  },
  {
    ...
    lat: 37.7699,
    lng: -122.4159,
    date: '2023-04-10T17:45:00',
    status: 'resolved'
  },
  {
    id: '7',
    type: 'Noise Complaint',
    description: 'Loud music from apartment complex',
    lat: 37.7799,
    lng: -122.4094,
    date: '2023-04-11T22:10:00',
    status: 'active'
  },
  {
    id: '8',
...
// List of available incident types for filtering
const incidentTypes = Array.from(new Set(mockIncidents.map(i => i.type)));
